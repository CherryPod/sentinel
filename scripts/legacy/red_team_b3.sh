#!/usr/bin/env bash
# B3 External Perimeter Red Team — Container, Network, Air Gap
#
...
#
# Usage:
#   bash scripts/red_team_b3.sh                    # Phase 1 only (default)
#   bash scripts/red_team_b3.sh --phase 2          # Phase 2 only
#   bash scripts/red_team_b3.sh --phase all         # Both phases
#   bash scripts/red_team_b3.sh --phase 2 --destructive  # Include destructive tests
#
...
RESULTS_FILE="$PROJECT_DIR/benchmarks/b3_perimeter_${TIMESTAMP}.jsonl"
...
_jsonl() {
    ...
    printf '{"phase":%s,"section":"%s","test":"%s","status":"%s","expected":"%s","actual":"%s","severity":"%s","timestamp":"%s"}\n' \
...
echo "============================================================"
echo "  Sentinel B3: External Perimeter Red Team"
echo "  $(date)"
echo "  Phase: $PHASE"
...
echo "============================================================"
echo "  B3 Perimeter Test Results"
echo "  Phase: $PHASE"
echo "  $(date)"
echo "============================================================"
