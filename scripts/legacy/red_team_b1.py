#!/usr/bin/env python3
"""B1: Adversarial User — Adaptive AI Red Team Test
...
A Claude Sonnet 4.5 "attacker brain" runs ~10 attack campaigns, each with
...
Usage:
    python3 scripts/red_team_b1.py
    python3 scripts/red_team_b1.py --campaigns scanner_learning encoding_adaptation
    python3 scripts/red_team_b1.py --output benchmarks/my_test.jsonl --verbose
"""
...
class B1RedTeam:
    ...
    def run_campaign(self, campaign: Campaign) -> CampaignState:
        ...
        source = f"red_team_b1_{campaign.campaign_id}"
...
def main():
    parser = argparse.ArgumentParser(
        description="B1: Adversarial User — Adaptive AI Red Team Test",
...
def _run(args):
    ...
    output_path = args.output or default_output_path("b1")
    ...
    with JsonlWriter(output_path) as writer:
        ...
        print_banner("B1: Adversarial User — Adaptive Red Team", CAMPAIGNS, selected)
