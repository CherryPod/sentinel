...
class ProvenanceStoreProtocol(Protocol):
    ...
    async def record_file_write(self, path: str, data_id: str, user_id: int | None = None) -> None: ...

    async def get_file_writer(self, path: str, user_id: int | None = None) -> str | None: ...
