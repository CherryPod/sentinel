...
**Data Source:** `scripts/results/stress_test_20260215_163114.jsonl` (1,136 prompts)
...
*Report generated from stress test v3 data (1,136 prompts, 2026-02-15). Raw data: `scripts/results/stress_test_20260215_163114.jsonl`. Drill into any entry: `python3 scripts/analyse_v3_results.py --show INDEX`.*
