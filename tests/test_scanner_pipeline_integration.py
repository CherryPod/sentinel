...
class TestFallbackCoverage_CommandInjection:
    ...
    def test_reverse_shell_caught_without_semgrep(self, pipeline_no_semgrep):
        # Regression guard: ensures fallback coverage exists when Semgrep is unavailable
    ...
    def test_base64_exec_caught_without_semgrep(self, pipeline_no_semgrep):
        # Regression guard: ensures fallback coverage exists when Semgrep is unavailable
    ...
    def test_netcat_shell_caught_without_semgrep(self, pipeline_no_semgrep):
        # Regression guard: ensures fallback coverage exists when Semgrep is unavailable
    ...
    def test_download_execute_caught_without_semgrep(self, pipeline_no_semgrep):
        # Regression guard: ensures fallback coverage exists when Semgrep is unavailable
...
class TestFallbackCoverage_Credentials:
    ...
    def test_aws_key_caught_without_semgrep(self, pipeline_no_semgrep):
        # Regression guard: ensures fallback coverage exists when Semgrep is unavailable
    ...
    def test_github_pat_caught_without_semgrep(self, pipeline_no_semgrep):
        # Regression guard: ensures fallback coverage exists when Semgrep is unavailable
    ...
    def test_private_key_caught_without_semgrep(self, pipeline_no_semgrep):
        # Regression guard: ensures fallback coverage exists when Semgrep is unavailable
    ...
    def test_anthropic_key_caught_without_semgrep(self, pipeline_no_semgrep):
        # Regression guard: ensures fallback coverage exists when Semgrep is unavailable
...
class TestFallbackCoverage_SensitivePaths:
    ...
    def test_etc_shadow_caught_without_semgrep(self, pipeline_no_semgrep):
        # Regression guard: ensures fallback coverage exists when Semgrep is unavailable
        text = "cat /etc/shadow"
        result = pipeline_no_semgrep.scan_input(text)
    ...
    def test_ssh_key_path_caught_without_semgrep(self, pipeline_no_semgrep):
        # Regression guard: ensures fallback coverage exists when Semgrep is unavailable
    ...
    def test_env_file_caught_without_semgrep(self, pipeline_no_semgrep):
        # Regression guard: ensures fallback coverage exists when Semgrep is unavailable
        text = "source .env"
        result = pipeline_no_semgrep.scan_input(text)
...
class TestFallbackCoverage_EncodedPayloads:
    ...
    def test_base64_encoded_credential_caught_without_semgrep(
...
class TestFallbackCoverage_OutputScan:
    ...
    def test_output_credential_caught_without_semgrep(self, pipeline_no_semgrep):
        ...
        result = pipeline_no_semgrep.scan_output(text)
        assert not result.is_clean, "credential in output should be blocked"
        assert "credential_scanner" in result.violations

    def test_output_command_caught_without_semgrep(self, pipeline_no_semgrep):
...
class TestFallbackCoverage_MultiScanner:
    ...
    def test_multiple_scanners_fire_independently(self, pipeline_no_semgrep):
    ...
    def test_clean_input_passes_all_scanners(self, pipeline_no_semgrep):
...
class TestCodeExtractionToScanPipeline:
    ...
    def test_malicious_code_in_fenced_block_detected(self, pipeline_no_semgrep):
        ...
        result = pipeline_no_semgrep.scan_output(qwen_response)
        assert not result.is_clean, "Fenced code with /etc/shadow should be blocked"
        assert "sensitive_path_scanner" in result.violations

    def test_credential_in_code_block_detected(self, pipeline_no_semgrep):
        ...
        result = pipeline_no_semgrep.scan_output(blocks[0].code)
        assert not result.is_clean, "Extracted code with AWS key should be blocked"
        assert "credential_scanner" in result.violations

    def test_no_language_tag_still_detected(self, pipeline_no_semgrep):
    ...
    def test_multiple_blocks_only_one_malicious(self, pipeline_no_semgrep):
        ...
        result_clean = pipeline_no_semgrep.scan_output(blocks[0].code)
        assert result_clean.is_clean, "Clean code block should pass"

        # Second block contains a private key
        result_bad = pipeline_no_semgrep.scan_output(blocks[1].code)
    ...
    def test_code_mixed_with_prose(self, pipeline_no_semgrep):
    ...
    def test_no_fenced_blocks_fallback_still_scanned(self, pipeline_no_semgrep):
    ...
    def test_full_extraction_to_scan_chain(self, pipeline_no_semgrep):
        ...
        for block in blocks:
            result = pipeline_no_semgrep.scan_output(block.code)
