...
class TestRealScanPipelineInput:
    ...
    def test_credential_in_input_detected(self, real_pipeline):
        ...
        result = real_pipeline.scan_input(malicious_input)
    ...
    def test_reverse_shell_in_input_detected(self, real_pipeline):
    ...
    def test_sensitive_path_in_input_detected(self, real_pipeline):
...
class TestScannerFailurePropagation:
    ...
    def test_crashed_scanner_fails_closed(self, real_pipeline):
        ...
        try:
            result = real_pipeline.scan_input("harmless text")
